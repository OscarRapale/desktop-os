          ...
          <div className={styles.work}>
            ...
            <div className={styles.shellfolio}>
              <div className={styles.projectImage}>
                <Image
                  src="/images/the-line.webp"
                  alt="Screen capture of Shell Portfolio"
                  width={300}
                  height={250}
                />
              </div>
            ...
            <div className={styles.simplePortfolio}>
              ...
              <div className={styles.projectContent}>
                ...
                <p>
                  ...
                  designed to present my work and capabilities as a developer.
            ...
            <div className={styles.jancuts}>
              ...
              <div className={styles.projectContent}>
                ...
                <p>
                  ...
                  barber that wanted to showcase his work and skills and the
                  services he is offering. The website is made with React.js and
