          ...
          <div className="work">
            ...
            <div className="theLine">
              ...
              <p>
                ...
                Built with vanilla HTML, CSS, and JavaScript, featuring elegant
                design, smooth animations, and comprehensive responsive layouts.
                A tribute to the tv show "The Bear". <br />
            ...
            <div className="shellfolio">
              ...
              <p>
                ...
                with vanilla JavaScript, HTML, and CSS. Experience my
            ...
            <div className="simplePortfolio">
              ...
              <img src="" alt="" />
              <p>
                This is my personal portfolio website built with HTML, designed
                to present my work and capabilities as a developer. The
                portfolio serves as a digital resume and project showcase.
                Including smooth animations. <br />
                <a href="">Visit My Portfolio</a>
              </p>
            </div>
            <div className="janCuts">
              <h2>Jan Cuts Portfolio</h2>
              <img src="" alt="" />
              <p>
                A portfolio website that was requested by a professional barber
                that wanted to showcase his work and skills and the services he
                is offering. The website is made with React.js and Chakra UI,
                and the UI was designed with Figma. <br />
